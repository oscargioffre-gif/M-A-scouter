...
/* HEADER */
.scouter-header{
    background:linear-gradient(160deg,#0a0a14 0%,#150820 40%,#0e0416 70%,#0a0a14 100%);
    border-bottom:3px solid #FF00AA44;
...
.scouter-header::before{
    content:'';position:absolute;top:0;left:0;right:0;height:1px;
    background:linear-gradient(90deg,transparent,#FF00AA66,transparent);
}
.scouter-row1{display:flex;align-items:center;gap:16px;margin-bottom:12px}
.scouter-icon{
    ...
    line-height:1;
    white-space:nowrap;
    box-shadow:0 4px 24px #FF00AA40,0 0 60px #FF00AA15;
    flex-shrink:0;
...
.scouter-title .hl{color:#FF00AA;font-style:normal}
.scouter-title .yr{color:#64748b;font-weight:600;font-size:24px;margin-left:4px}
.scouter-sub{
    font-size:13px;
    color:#64748b;
    letter-spacing:.3px;
...
@media(max-width:900px){
    .scouter-title{font-size:26px}
    .scouter-title .yr{font-size:20px}
}
/* MOBILE */
@media(max-width:640px){
    .scouter-header{padding:18px 14px 14px;margin:-1rem -.8rem 1rem}
    .scouter-icon{font-size:18px;padding:10px 14px;border-radius:12px}
    .scouter-title{font-size:22px}
    .scouter-title .yr{font-size:17px;display:block;margin-left:0;margin-top:2px}
    .scouter-sub{font-size:11px}
    .scouter-live{font-size:10px}
...
@media(max-width:380px){
    .scouter-title{font-size:19px}
    .scouter-icon{font-size:15px;padding:8px 11px}
}
...
<div class="scouter-header">
  <div class="scouter-row1">
    <div class="scouter-icon">M&amp;A</div>
    <div class="scouter-v">v5.0 LIVE</div>
  </div>
  <div class="scouter-title">
    BIOTECH <em class="hl">M&amp;A</em> SCOUTER<span class="yr">2026</span>
  </div>
